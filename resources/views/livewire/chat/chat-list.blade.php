                        ...
                        <aside class="grid grid-cols-12 w-full">
                            <a href="{{ route('chat', $conversation->id) }}"
                                ...
                                <div class="flex justify-between w-full items-center">
                                    ...
                                    <small
                                        class="text-gray-500">{{ $conversation->messages?->last()?->created_at?->shortAbsoluteDiffForHumans() }}</small>
                                ...
                                <x-dropdown align="right" width="48">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <div class="w-full p-1">
                                            <button
                                                class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100">
                                                <span>
